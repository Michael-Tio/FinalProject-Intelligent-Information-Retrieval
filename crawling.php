...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="styles/crawling.css">
        <title>Crawling - IIR Project</title>
    </head>
    <body>
        <header>
        ...
        <section>
            <form action="" method="get">
                ...
                <div class="search">
                    ...
                    <input type="submit" name="submit" class="search-submit" value="Crawl">
                </div>
            </form>
        </section>
    </body>
